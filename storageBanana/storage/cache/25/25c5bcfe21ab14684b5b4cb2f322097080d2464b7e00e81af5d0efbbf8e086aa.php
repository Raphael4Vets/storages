...
class __TwigTemplate_26710bb68c36d22f014042c26d62d7b791e18a127c17cb47eb9d7e1b1d6c5f36 extends Twig_Template
{
...
/*               <div class="button-group">*/
/* 		{% if logged%}*/
/*                <button type="button"><a href="{{ product.href }}"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">{{ button_cart }}</span></a></button>*/
